...
qryMVQSS=paste0("SELECT mv_qs_facts.symbol, mv_qs_facts.date, mv_qs_facts.close as adj_close FROM mv_qs_facts INNER JOIN mv_qs_symbol_subset ON mv_qs_facts.symbol=mv_qs_symbol_subset.symbol;")
